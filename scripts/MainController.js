	...
	function MainController(province) {
		...
		vm.rentalFields = [
			...
			},
			{
				...
				validators: {
					// Custom validator to check whether the driver's license number that the user enters is valid or not
...
// Tests the input based on a helpful regular expression gratefully borrowed from jQuery.formance by Omar Shammas
